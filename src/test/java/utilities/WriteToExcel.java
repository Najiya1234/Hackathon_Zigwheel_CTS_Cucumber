...
//	 	file = new FileInputStream(".\\Excel\\New_Bikes.xlsx");
	 	file = new FileInputStream(System.getProperty("user.dir")+"\\TestData\\NewBikes_Excel_cucumber.xlsx");
	    ...
	    try {
	        ...
	        fileoutput= new FileOutputStream(System.getProperty("user.dir")+"\\TestData\\NewBikes_Excel_cucumber.xlsx");;
